...
export const SEED_KEYWORDS = [
  ...
  'ダイエット 続かない', 'ダイエット やる気 出ない', 'ダイエット 始められない',
  'ダイエット モチベーション', 'ダイエット 習慣化', 'ダイエット 挫折',
...
function inferCategory(keyword, seed) {
  ...
  if (/続かない|やる気|始められない|モチベ|習慣化|挫折|三日坊主|メンタル|自分に甘い|食べてしまう|ストレス/.test(text)) return 'ダイエットマインド';
