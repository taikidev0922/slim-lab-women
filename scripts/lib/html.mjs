...
<body class="article-page">
  <header class="site-header" id="header">
    ...
    <nav class="site-nav" id="siteNav"><a href="/">ホーム</a><a href="/blog/" aria-current="page">記事一覧</a><a href="/about/">運営方針</a></nav>
  </header>
  <main>
  ...
  <footer class="site-footer"><p class="brand brand--footer"><span class="brand__mark">美</span><span class="brand__text">${escapeHtml(config.siteName)}</span></p><nav><a href="/about/">運営方針</a><a href="/sitemap.xml">サイトマップ</a></nav><small>&copy; 2026 ${escapeHtml(config.siteName)}</small></footer>
